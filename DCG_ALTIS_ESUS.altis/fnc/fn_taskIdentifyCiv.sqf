...
_taskText = "Ident. Politico";
_taskDescription = "Otro politico de la zona ha sido ejecutado en directo hace unas horas. Despues del evento, el gobierno nos ha culpado por lo sucedido, pero la información actual obtenida detalla quien es el culpable. Sus ordenes son infiltrarse en el campamento e identificar al politico.";
