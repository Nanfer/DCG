...
if (SEN_allowMod isEqualTo 1) then { // if modified content mission parameter is on
	...
	if (_return) then {
		...
		_indVehPool = ["LOP_ISTS_Landrover","LOP_ISTS_Landrover_M2","LOP_ISTS_Offroad","LOP_ISTS_Offroad_M2","LOP_ISTS_Truck","LOP_ISTS_M113_W","LOP_ISTS_BTR60","LOP_ISTS_T72BA","LOP_ISTS_Static_M2","LOP_ISTS_Static_M2_MiniTripod","LOP_ISTS_Static_Mk19_TriPod"];
		...
		_indSniperPool = [];
		_eastSniperPool = [];
		_indOfficerPool = ["LOP_AFR_Infantry_SL"];
