...
[] spawn {
	...
	closeDialog 0;
	_ret = [
		parseText "<img size='3' valign='top' align='center' image='media\SEN_imgLogo.paa'/><br/><br/><t align='center'>Bienvenido a DCG FATA ESUS v1</t><br/><br/><t align='center'>Version: 3.0.9.1</t><br/>",
